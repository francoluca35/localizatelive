...
// ✅ Componente de icono personalizado con React Icons
const CustomMarkerIcon = () =>
  L.divIcon({
    className: "",
    html: `<div style="color:red; font-size: 32px;">📍</div>`, // usa cualquier emoji o cambia por un div con CSS si querés más estilo
    iconSize: [30, 42],
    iconAnchor: [15, 42],
  });
